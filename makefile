prog: assembler.o preassembler.o macro.o files.o strings.o firstphase.o symbols.o
	gcc -g -ansi -pedantic -Wall assembler.o macro.o preassembler.o files.o strings.o firstphase.o symbols.o -o prog
assembler.o: ./assembler/assembler.c ./assembler/assembler.h ./preassembler/preassembler.h ./firstphase/firstphase.h ./symbols/symbols.h
...
firstphase.o: ./firstphase/firstphase.c ./firstphase/firstphase.h ./strings/strings.h ./files/files.h ./assembler/assembler.h ./symbols/symbols.h
